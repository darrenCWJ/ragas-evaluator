...
export const FALLBACK_MODELS: JudgeModel[] = [
  { id: 'gpt-5.1', name: 'GPT-5.1', provider: 'openai', available: true },
  ...
  { id: 'gemini-3-pro-preview', name: 'Gemini 3 Pro', provider: 'gemini', available: false },
  { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', provider: 'gemini', available: false },
  { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', provider: 'gemini', available: false },
];
