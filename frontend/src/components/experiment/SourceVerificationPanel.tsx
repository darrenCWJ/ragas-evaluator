        ...
        {groups.map((g) => (
          ...
          >
            <summary className="flex cursor-pointer items-center justify-between px-4 py-2.5 text-sm">
              <span className="font-medium text-text-primary truncate mr-2">{g.question}</span>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {v.url && <p className="text-xs text-accent truncate">{v.url}</p>}
                      {v.details && <p className="mt-1 text-xs text-text-muted">{v.details}</p>}
                    </div>
                  </div>
                );
              })}
